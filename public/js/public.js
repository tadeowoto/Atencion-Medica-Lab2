        ...
        .then((agenda) => {
          ...
          agenda.forEach((turno) => {
            ...
            if (turno.estado === "pendiente") {
              ...
              divActions.innerHTML += `<a href="/paciente/${turno.paciente}" class="inline-flex items-center justify-center text-sm font-medium transition-colors border border-input bg-transparent hover:bg-primaryForeground/5 h-9 rounded-md px-3">Ver HCE</a>`;
            }
